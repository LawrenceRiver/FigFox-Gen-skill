...
The FigureBench retrieval may be computed earlier in parallel, but its effect is applied only at the single inspection/patch gate after the direct image-generation call.
